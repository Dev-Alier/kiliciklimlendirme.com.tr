...
<head>
    <meta charset="utf-8" />
    <title> <?php echo $__env->yieldContent('title'); ?> | Kılıç İklimlendirme Admin Paneli</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="domain satis sitesi" name="description" />
    <meta content="Themesdesign" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo e(URL::asset('assets/images/'.$setting->logo)); ?>">
...
<?php /**PATH D:\projects\my project\laravel\kiliciklimlendirme2\kiliciklimlendirme\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>