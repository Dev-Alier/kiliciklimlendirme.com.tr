...
@section('title')
    @lang('Hizmet Kategori Ekle-Düzenle')
@endsection
@section('css')
...
@section('content')
    @component('admin.components.breadcrumb')
        ...
        @endslot
        @slot('title')
        {{ $category->id ? __('Hizmeti Düzenle') : __('Yeni Hizmet Ekle') }}
        @endslot
    @endcomponent
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center">
                    <h3>
                        {{ $category->id ? __('Hizmet Kategorisi Düzenle') : __('Hizmet Kategorisi Ekle') }}
                    </h3>
                </div>
                <form class="needs-validation" novalidate method="post" action="{{ route('add.post.serviceCategory') }}"
